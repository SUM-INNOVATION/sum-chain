...
- **Phase 5 (docs)** — ahead. `docs/SUBPROTOCOLS/INFERENCE-ATTESTATION.md` describing the wire surface, activation procedure, curl recipes for the three RPC methods, and the OmniNode Stage 6 handoff contract.

**Last Updated**: 2026-05-13 (OmniNode Phase 4 production wiring + RPC complete)

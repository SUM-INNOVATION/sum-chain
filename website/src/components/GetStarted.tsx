      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 text-lg font-medium rounded-full bg-white text-[#0a0a0a] hover:bg-gray-100 transition-all duration-300"
          >

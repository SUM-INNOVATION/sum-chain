...
**Status:** v1 implementation complete on `omninode-attestation` branch; mainnet activation pending
**Created:** 2026-05-13
...
| Reward / slash / dispute tx families | Settlement and dispute are a separate protocol surface, referenced by `(session_id, verifier_address)`. v1 commits to attestation immutability; economics come later. | Future protocol versions |

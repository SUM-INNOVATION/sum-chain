...
| OV-6..OV-11, OV-15, OV-16, OV-19, OV-21..OV-25, OV-27, OV-30, CI-1, CO-1, MD-1, MD-2, PA-1 | untouched by the Class 8 pass that closed the ten rows above. The pass chose depth over breadth: four gates, ten rows, each with a mixed-version test that shows an ungated and a gated node disagreeing and a closed-gate test that reproduces today's behaviour exactly. Nothing about these rows changed, and none of them was investigated far enough to move a verdict |

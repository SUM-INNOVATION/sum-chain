...
| ~~#203~~ **RESOLVED** | RUSTSEC-2026-0235 | rkyv 0.7 → 0.8 ✅ | **PROD** (hard) — cleared | consensus/node → state → sumc-runtime → wasmer → rkyv | execution / wasmer-runtime | ✅ done | **met**: wasmer 4.x→7.4 migration brought rkyv **0.8.18** (≥ 0.8.17) and rkyv 0.7.46 left the lock; exception removed |

...
fn run() -> Result<String, String> {
    ...
    let record = serde_json::json!({
        ...
        "cpuset_source_cgroup_path": facts.cpuset_source_cgroup_path,
        "cpuset_raw": facts.cpuset_raw,
        "cpuset_inherited": facts.cpuset_inherited,
        "cpuset_probe_chain": facts.cpuset_probe_chain,

...
//!
//! Byte-identical to the frozen reference `b0-pre-validator/src/fixed.rs`. The
//! guest cannot depend on that std+bignum host tool, so the leaf is reproduced
//! here; `tests/reference_agreement.rs` re-executes the official golden fixture
//! through this arithmetic and rejects any drift.
//!

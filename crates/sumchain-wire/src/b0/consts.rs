...
// Copied verbatim from the frozen B0-PRE candidate-neutral wire types. Some
// constants are not referenced by this production subset but are retained so the
// frozen scalar set stays byte-identical to the reference.
#![allow(dead_code)]

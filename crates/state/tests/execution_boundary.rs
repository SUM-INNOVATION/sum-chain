...
fn migrated_execution_paths_take_no_self_receiver() {
    ...
    const EXECUTION_FNS: &[(&str, &str)] = &[
        ...
        // Agreements. Eight families; the two index appends are private
        // helpers and are listed too, because a receiver on either would
        // reopen the committed path from inside the view module.
        ("agreement_view.rs", "fn v_get_agreement("),
        ("agreement_view.rs", "fn v_agreement_exists("),
        ("agreement_view.rs", "fn v_put_agreement("),
        ("agreement_view.rs", "fn v_get_party_agreement_ids("),
        ("agreement_view.rs", "fn v_add_to_party_index("),
        ("agreement_view.rs", "fn v_update_agreement_status("),
        ("agreement_view.rs", "fn v_mark_party_signed("),
        ("agreement_view.rs", "fn v_get_signature("),
        ("agreement_view.rs", "fn v_signature_exists("),
        ("agreement_view.rs", "fn v_put_signature("),
        ("agreement_view.rs", "fn v_delete_signature("),
        ("agreement_view.rs", "fn v_get_attestation("),
        ("agreement_view.rs", "fn v_attestation_exists("),
        ("agreement_view.rs", "fn v_put_attestation("),
        ("agreement_view.rs", "fn v_update_attestation_status("),
        ("agreement_view.rs", "fn v_get_ip_action("),
        ("agreement_view.rs", "fn v_ip_action_exists("),
        ("agreement_view.rs", "fn v_put_ip_action("),
        ("agreement_view.rs", "fn v_update_ip_action_status("),
        ("agreement_view.rs", "fn v_get_executor_link("),
        ("agreement_view.rs", "fn v_executor_link_exists("),
        ("agreement_view.rs", "fn v_put_executor_link("),
        ("agreement_view.rs", "fn v_get_executor_link_ids("),
        ("agreement_view.rs", "fn v_add_to_executor_index("),
        ("agreement_view.rs", "fn v_update_executor_state("),
        ("agreement_view.rs", "fn v_proof_exists("),
        ("agreement_view.rs", "fn v_put_proof("),
        ("agreement_executor.rs", "fn execute("),
        // Property, title, encumbrance and insurance. Eleven families behind
        // thirty-five accessors; the five index appends are private helpers and
        // are listed too, because a receiver on any one of them would reopen the
        // committed path from inside the view module.
        ("property_view.rs", "fn v_get_asset("),
        ("property_view.rs", "fn v_asset_exists("),
        ("property_view.rs", "fn v_put_asset("),
        ("property_view.rs", "fn v_get_jurisdiction_asset_ids("),
        ("property_view.rs", "fn v_add_to_jurisdiction_index("),
        ("property_view.rs", "fn v_update_asset_status("),
        ("property_view.rs", "fn v_get_title_event("),
        ("property_view.rs", "fn v_title_event_exists("),
        ("property_view.rs", "fn v_put_title_event("),
        ("property_view.rs", "fn v_get_asset_title_event_ids("),
        ("property_view.rs", "fn v_add_to_asset_title_index("),
        ("property_view.rs", "fn v_update_title_event_status("),
        ("property_view.rs", "fn v_get_encumbrance("),
        ("property_view.rs", "fn v_encumbrance_exists("),
        ("property_view.rs", "fn v_put_encumbrance("),
        ("property_view.rs", "fn v_get_asset_encumbrance_ids("),
        ("property_view.rs", "fn v_add_to_asset_encumbrance_index("),
        ("property_view.rs", "fn v_update_encumbrance_status("),
        ("property_view.rs", "fn v_get_coverage("),
        ("property_view.rs", "fn v_coverage_exists("),
        ("property_view.rs", "fn v_put_coverage("),
        ("property_view.rs", "fn v_get_asset_coverage_ids("),
        ("property_view.rs", "fn v_add_to_asset_coverage_index("),
        ("property_view.rs", "fn v_update_coverage_status("),
        ("property_view.rs", "fn v_renew_coverage("),
        ("property_view.rs", "fn v_get_claim("),
        ("property_view.rs", "fn v_claim_exists("),
        ("property_view.rs", "fn v_put_claim("),
        ("property_view.rs", "fn v_get_coverage_claim_ids("),
        ("property_view.rs", "fn v_add_to_coverage_claim_index("),
        ("property_view.rs", "fn v_update_claim_status("),
        ("property_view.rs", "fn v_approve_claim("),
        ("property_view.rs", "fn v_pay_claim("),
        ("property_view.rs", "fn v_property_proof_exists("),
        ("property_view.rs", "fn v_put_property_proof("),
        ("property_executor.rs", "fn execute("),
        // Healthcare. Ten families behind thirty-six accessors. The five index
        // appends and the one index REMOVE are private helpers and are listed
        // too, because a receiver on any of them would reopen the committed
        // path from inside the view module -- and the remove is the only
        // unconditional index write in the subsystem.
        ("healthcare_view.rs", "fn v_get_provider("),
        ("healthcare_view.rs", "fn v_provider_exists("),
        ("healthcare_view.rs", "fn v_put_provider("),
        ("healthcare_view.rs", "fn v_get_network_provider_ids("),
        ("healthcare_view.rs", "fn v_add_to_network_index("),
        ("healthcare_view.rs", "fn v_remove_from_network_index("),
        ("healthcare_view.rs", "fn v_update_provider_status("),
        ("healthcare_view.rs", "fn v_add_network_affiliation("),
        ("healthcare_view.rs", "fn v_remove_network_affiliation("),
        ("healthcare_view.rs", "fn v_get_membership("),
        ("healthcare_view.rs", "fn v_membership_exists("),
        ("healthcare_view.rs", "fn v_put_membership("),
        ("healthcare_view.rs", "fn v_get_member_membership_ids("),
        ("healthcare_view.rs", "fn v_add_to_member_index("),
        ("healthcare_view.rs", "fn v_update_membership_status("),
        ("healthcare_view.rs", "fn v_renew_membership("),
        ("healthcare_view.rs", "fn v_add_dependent("),
        ("healthcare_view.rs", "fn v_remove_dependent("),
        ("healthcare_view.rs", "fn v_get_consent("),
        ("healthcare_view.rs", "fn v_consent_exists("),
        ("healthcare_view.rs", "fn v_put_consent("),
        ("healthcare_view.rs", "fn v_get_subject_consent_ids("),
        ("healthcare_view.rs", "fn v_add_to_subject_index("),
        ("healthcare_view.rs", "fn v_update_consent_status("),
        ("healthcare_view.rs", "fn v_get_prescription("),
        ("healthcare_view.rs", "fn v_prescription_exists("),
        ("healthcare_view.rs", "fn v_put_prescription("),
        ("healthcare_view.rs", "fn v_get_patient_rx_ids("),
        ("healthcare_view.rs", "fn v_get_prescriber_rx_ids("),
        ("healthcare_view.rs", "fn v_add_to_patient_index("),
        ("healthcare_view.rs", "fn v_add_to_prescriber_index("),
        ("healthcare_view.rs", "fn v_update_prescription_status("),
        ("healthcare_view.rs", "fn v_record_fill("),
        ("healthcare_view.rs", "fn v_add_fill_history("),
        ...
        // Employment. Nine families -- four row families and the five
        // accumulating index families -- behind one write site each. The
        // executor is a unit struct, so no operation can reach a database.
        ("employment_view.rs", "fn v_get_issuer("),
        ("employment_view.rs", "fn v_issuer_exists("),
        ("employment_view.rs", "fn v_put_issuer("),
        ("employment_view.rs", "fn v_write_issuer_row("),
        ("employment_view.rs", "fn v_update_issuer_status("),
        ("employment_view.rs", "fn v_get_credential("),
        ("employment_view.rs", "fn v_credential_exists("),
        ("employment_view.rs", "fn v_put_credential("),
        ("employment_view.rs", "fn v_write_credential_row("),
        ("employment_view.rs", "fn v_update_credential_status("),
        ("employment_view.rs", "fn v_revoke_credential("),
        ("employment_view.rs", "fn v_get_employee_credential_ids("),
        ("employment_view.rs", "fn v_add_to_employee_index("),
        (
            "employment_view.rs",
            "fn v_get_employee_address_credential_ids(",
        ),
        ("employment_view.rs", "fn v_add_to_employee_address_index("),
        ("employment_view.rs", "fn v_get_employer_credential_ids("),
        ("employment_view.rs", "fn v_add_to_employer_index("),
        ("employment_view.rs", "fn v_get_attestation("),
        ("employment_view.rs", "fn v_attestation_exists("),
        ("employment_view.rs", "fn v_put_attestation("),
        ("employment_view.rs", "fn v_write_attestation_row("),
        ("employment_view.rs", "fn v_revoke_attestation("),
        ("employment_view.rs", "fn v_get_subject_attestation_ids("),
        ("employment_view.rs", "fn v_add_to_subject_income_index("),
        (
            "employment_view.rs",
            "fn v_get_holder_address_attestation_ids(",
        ),
        ("employment_view.rs", "fn v_add_to_holder_address_index("),
        ("employment_view.rs", "fn v_get_proof("),
        ("employment_view.rs", "fn v_proof_exists("),
        ("employment_view.rs", "fn v_put_proof("),
        ("employment_executor.rs", "fn execute("),
        // Legal. Eight families behind five sub-stores, fourteen accessors and
        // three private index appends; the executor is a unit struct, so no
        // operation can reach a database. `exists` is `contains`, not a decode,
        // which is why the duplicate guards take their own accessors.
        ("legal_view.rs", "fn v_get_case("),
        ("legal_view.rs", "fn v_case_exists("),
        ("legal_view.rs", "fn v_put_case("),
        ("legal_view.rs", "fn v_update_case_status("),
        ("legal_view.rs", "fn v_add_related_case("),
        ("legal_view.rs", "fn v_get_jurisdiction_ids("),
        ("legal_view.rs", "fn v_add_to_jurisdiction_index("),
        ("legal_view.rs", "fn v_get_process_event("),
        ("legal_view.rs", "fn v_process_event_exists("),
        ("legal_view.rs", "fn v_put_process_event("),
        ("legal_view.rs", "fn v_update_process_event_status("),
        ("legal_view.rs", "fn v_get_case_event_ids("),
        ("legal_view.rs", "fn v_add_to_case_event_index("),
        ("legal_view.rs", "fn v_get_order("),
        ("legal_view.rs", "fn v_order_exists("),
        ("legal_view.rs", "fn v_put_order("),
        ("legal_view.rs", "fn v_update_order_status("),
        ("legal_view.rs", "fn v_get_case_order_ids("),
        ("legal_view.rs", "fn v_add_to_case_order_index("),
        ("legal_view.rs", "fn v_get_benefit("),
        ("legal_view.rs", "fn v_benefit_exists("),
        ("legal_view.rs", "fn v_put_benefit("),
        ("legal_view.rs", "fn v_update_benefit_status("),
        ("legal_view.rs", "fn v_get_proof("),
        ("legal_view.rs", "fn v_proof_exists("),
        ("legal_view.rs", "fn v_put_proof("),
        ("legal_executor.rs", "fn execute("),
        // Finance. Nine families across five sub-stores, four of them
        // accumulating indexes: every append is a read-modify-write that has
        // to see the candidate. The executor is a unit struct now, so there is
        // no `self.db` for a committed read or write to come from.
        ("finance_view.rs", "fn v_get_issuer("),
        ("finance_view.rs", "fn v_issuer_exists("),
        ("finance_view.rs", "fn v_put_issuer("),
        ("finance_view.rs", "fn v_update_issuer_status("),
        ("finance_view.rs", "fn v_get_jurisdiction_issuer_addresses("),
        ("finance_view.rs", "fn v_add_to_jurisdiction_index("),
        ("finance_view.rs", "fn v_get_address_proof("),
        ("finance_view.rs", "fn v_address_proof_exists("),
        ("finance_view.rs", "fn v_put_address_proof("),
        ("finance_view.rs", "fn v_revoke_address_proof("),
        ("finance_view.rs", "fn v_get_subject_address_proof_ids("),
        ("finance_view.rs", "fn v_add_to_subject_address_index("),
        ("finance_view.rs", "fn v_get_bank_standing("),
        ("finance_view.rs", "fn v_bank_standing_exists("),
        ("finance_view.rs", "fn v_put_bank_standing("),
        ("finance_view.rs", "fn v_update_bank_standing("),
        ("finance_view.rs", "fn v_revoke_bank_standing("),
        ("finance_view.rs", "fn v_get_subject_bank_standing_ids("),
        ("finance_view.rs", "fn v_add_to_subject_bank_index("),
        ("finance_view.rs", "fn v_get_kyc_attestation("),
        ("finance_view.rs", "fn v_kyc_attestation_exists("),
        ("finance_view.rs", "fn v_put_kyc_attestation("),
        ("finance_view.rs", "fn v_update_kyc_status("),
        ("finance_view.rs", "fn v_revoke_kyc_attestation("),
        ("finance_view.rs", "fn v_get_subject_kyc_ids("),
        ("finance_view.rs", "fn v_add_to_subject_kyc_index("),
        ("finance_view.rs", "fn v_proof_exists("),
        ("finance_view.rs", "fn v_put_proof("),
        ("finance_executor.rs", "fn execute("),
        ...
        ("token_view.rs", "fn v_get_balance("),
        ("token_view.rs", "fn v_set_balance("),
        ("token_view.rs", "fn v_get_allowance("),
        ("token_view.rs", "fn v_set_allowance("),
        ("token_view.rs", "fn v_get_holder_tokens("),
        ("token_view.rs", "fn v_add_to_holder_index("),
        ("token_view.rs", "fn v_remove_from_holder_index("),
        ("equity_view.rs", "fn v_get_entity("),
        ("equity_view.rs", "fn v_put_entity("),
        ("equity_view.rs", "fn v_get_governance_action("),
        ("equity_view.rs", "fn v_get_entity_actions("),
        ("equity_view.rs", "fn v_put_governance_action("),
        ("equity_view.rs", "fn v_get_equity_token("),
        ("equity_view.rs", "fn v_put_equity_token("),
        ("equity_view.rs", "fn v_get_equity_balance("),
        ("equity_view.rs", "fn v_set_equity_balance("),
        ("equity_view.rs", "fn v_transfer_equity("),
        ("equity_view.rs", "fn v_get_equity_holders("),
        ("equity_view.rs", "fn v_get_equity_holdings("),
        ("equity_view.rs", "fn v_add_to_holder_index("),
        ("equity_view.rs", "fn v_remove_from_holder_index("),
        ("equity_view.rs", "fn v_equity_balances_root("),
        ("equity_view.rs", "fn v_get_ownership_proof("),
        ("equity_view.rs", "fn v_put_ownership_proof("),
        ("governance_view.rs", "fn v_put_asset("),
        ("governance_view.rs", "fn v_get_asset("),
        ("governance_view.rs", "fn v_get_proposal("),
        ("governance_view.rs", "fn v_put_proposal("),
        ("governance_view.rs", "fn v_create_proposal("),
        ("governance_view.rs", "fn v_put_vote("),
        ("governance_view.rs", "fn v_get_vote("),
        ("governance_view.rs", "fn v_list_votes("),
        ("governance_view.rs", "fn v_record_equity_vote("),
        ("governance_view.rs", "fn v_is_equity_commitment_used("),
        ("governance_view.rs", "fn v_get_snapshot("),
        ("governance_view.rs", "fn v_list_snapshot("),
        ("governance_view.rs", "fn v_put_qualifying_asset("),
        ("governance_view.rs", "fn v_list_effective_qualifying_assets("),
        ("governance_view.rs", "fn v_put_equity_class_root("),
        ("governance_view.rs", "fn v_get_equity_class_root("),
        ("governance_view.rs", "fn v_scan_token_holders("),
        ("governance_view.rs", "fn v_token_balance("),
        ("token_executor.rs", "fn execute("),
        ("token_executor.rs", "fn apply_policy_admin_op("),
        ("token_executor.rs", "fn deduct_fee("),
        ("token_executor.rs", "fn execute_create("),
        ("token_executor.rs", "fn execute_mint("),
        ("token_executor.rs", "fn execute_burn("),
        ("token_executor.rs", "fn execute_transfer("),
        ("token_executor.rs", "fn execute_approve("),
        ("token_executor.rs", "fn execute_transfer_from("),
        ("token_executor.rs", "fn execute_pause("),
        ("token_executor.rs", "fn execute_unpause("),
        ("token_executor.rs", "fn execute_transfer_ownership("),
        ("token_executor.rs", "fn execute_add_minter("),
        ("token_executor.rs", "fn execute_remove_minter("),
        ("equity_executor.rs", "fn execute("),
        ("equity_executor.rs", "fn create_entity("),
        ("equity_executor.rs", "fn update_entity("),
        ("equity_executor.rs", "fn add_controller("),
        ("equity_executor.rs", "fn remove_controller("),
        ("equity_executor.rs", "fn propose_action("),
        ("equity_executor.rs", "fn handle_governance("),
        ("equity_executor.rs", "fn create_token("),
        ("equity_executor.rs", "fn handle_token_update("),
        ...
        ("governance_executor.rs", "fn validate_register("),
        ("governance_executor.rs", "fn validate_register_qualifying("),
        ("governance_executor.rs", "fn validate_register_equity_class("),
        ("governance_executor.rs", "fn validate_equity_vote("),
        ("governance_executor.rs", "fn equity_vote_merkle_ok("),
        ("governance_executor.rs", "fn validate_create("),
        ("governance_executor.rs", "fn build_native_eligibility_snapshot("),
        ("governance_executor.rs", "fn build_equity_class_snapshot("),
        ("governance_executor.rs", "fn validate_vote("),
        ("governance_executor.rs", "fn validate_execute("),
        ("governance_executor.rs", "fn validate_cancel("),
        // DocClass, SRC-80X/81X. Eight families behind twenty-eight
        // accessors, and nineteen operations behind a unit-struct executor.
        // The four index appends are private helpers and are listed too,
        // because a receiver on any one of them would reopen the committed
        // path from inside the view module. `is_docclass_admin` is NOT here:
        // it reads `ChainParams` and no row at all, so it takes no view.
        ("docclass_view.rs", "fn v_get_identity_root("),
        ("docclass_view.rs", "fn v_identity_root_exists("),
        ("docclass_view.rs", "fn v_put_identity_root("),
        ("docclass_view.rs", "fn v_get_subject_identity_entries("),
        ("docclass_view.rs", "fn v_add_to_subject_identity_index("),
        ("docclass_view.rs", "fn v_update_identity_status("),
        ("docclass_view.rs", "fn v_get_subject_credential_ids("),
        ("docclass_view.rs", "fn v_add_to_subject_credential_index("),
        ("docclass_view.rs", "fn v_get_issuer_credential_ids("),
        ("docclass_view.rs", "fn v_add_to_issuer_credential_index("),
        ("docclass_view.rs", "fn v_get_eligibility("),
        ("docclass_view.rs", "fn v_eligibility_exists("),
        ("docclass_view.rs", "fn v_put_eligibility("),
        ("docclass_view.rs", "fn v_update_eligibility_revocation("),
        ("docclass_view.rs", "fn v_get_credential("),
        ("docclass_view.rs", "fn v_credential_exists("),
        ("docclass_view.rs", "fn v_put_credential("),
        ("docclass_view.rs", "fn v_update_credential_revocation("),
        ("docclass_view.rs", "fn v_put_revocation_record("),
        ("docclass_view.rs", "fn v_get_revocations_for_credential("),
        ("docclass_view.rs", "fn v_get_latest_revocation("),
        ("docclass_view.rs", "fn v_get_revocation_status("),
        ("docclass_view.rs", "fn v_get_docclass_issuer("),
        ("docclass_view.rs", "fn v_issuer_is_registered("),
        ("docclass_view.rs", "fn v_put_docclass_issuer("),
        ("docclass_view.rs", "fn v_can_issue_subcode("),
        ("docclass_view.rs", "fn v_update_docclass_issuer_status("),
        ("docclass_view.rs", "fn v_put_docclass_event("),
        ("docclass_executor.rs", "fn execute("),
        ("docclass_executor.rs", "fn create_identity_root("),
        ("docclass_executor.rs", "fn identity_add_key("),
        ("docclass_executor.rs", "fn identity_remove_key("),
        ("docclass_executor.rs", "fn identity_rotate_key("),
        ("docclass_executor.rs", "fn identity_add_controller("),
        ("docclass_executor.rs", "fn identity_remove_controller("),
        ("docclass_executor.rs", "fn identity_update_service("),
        ("docclass_executor.rs", "fn deactivate_identity("),
        ("docclass_executor.rs", "fn reactivate_identity("),
        ("docclass_executor.rs", "fn issue_credential("),
        ("docclass_executor.rs", "fn issue_academic_credential("),
        ("docclass_executor.rs", "fn issue_eligibility("),
        ("docclass_executor.rs", "fn update_credential("),
        ("docclass_executor.rs", "fn revoke_credential("),
        ("docclass_executor.rs", "fn suspend_credential("),
        ("docclass_executor.rs", "fn reactivate_credential("),
        ("docclass_executor.rs", "fn supersede_credential("),
        ("docclass_executor.rs", "fn check_revoke_auth("),
        ("docclass_executor.rs", "fn register_issuer("),
        ("docclass_executor.rs", "fn update_issuer("),
        ("docclass_executor.rs", "fn rotate_issuer_key("),
        ("docclass_executor.rs", "fn deactivate_issuer("),
    ];
